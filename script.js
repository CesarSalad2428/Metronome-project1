...
// Audios
// =================
const clickSound = document.getElementById("PLACEHOLDER");
...
const rudimentImage = document.getElementById("rudiment-image");
const selectedText = document.getElementById("selected-rudiment");

const rudimentCard = document.querySelector(".rudiment-card");
document.querySelectorAll(".dropdown-item").forEach(item => {
    ...
    item.addEventListener("click", () => {
        ...
        rudimentImage.src = "rudiments/" + item.dataset.image;

        rudimentCard.classList.remove("hidden");
    });
